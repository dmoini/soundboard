...
export { default as ChrisPterodactylImage } from "./chris-pterodactyl.png";
export { default as ChrisSpanishImage } from "./chris-spanish.jpg";
export { default as ChrisSquealImage } from "./chris-squeal.jpg";
export { default as ChrisTurkeySnipeImage } from "./chris-turkey-snipe.png";
export { default as ElvinYouNeedToGoThroughPubertyAgainImage } from "./elvin-you-need-to-go-through-puberty-again.jpg";
